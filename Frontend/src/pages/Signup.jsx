    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-2xl shadow-2xl p-8 md:p-10">
          ...
          <p className="text-white/70 mb-8 text-center">Join Vane.ai to get started</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-white/80 mb-1.5">Choose a Username</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-white/80 mb-1.5">Choose a Password</label>
              <input
                type="password"
